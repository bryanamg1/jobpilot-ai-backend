...
const envSchema = z.object({
  ...
  OPENAI_MAX_RETRIES: z.coerce.number().default(0),
  OPENAI_ENRICHMENT_TIMEOUT_MS: z.coerce.number().default(12_000),
  OPENAI_ENRICHMENT_RETRY_ATTEMPTS: z.coerce.number().default(1),
  OPENAI_DRAFT_TIMEOUT_MS: z.coerce.number().default(12_000),
  OPENAI_DRAFT_RETRY_ATTEMPTS: z.coerce.number().default(1),
